...
import in.rgukt.r081247.java.datastructure.tree.LinkedBinaryTree;
import in.rgukt.r081247.java.datastructure.tree.Position;
...
public class TreeMap<K, V> extends AbstractSortedMap<K, V> {
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
        ...
        public void rotate(Position<Entry<K, V>> p) {
            ...
            if (z == null) { // x becomes root of the tree
                root = x;
                x.setParent(null);
            } else {
     ...
     * @return Position holding key, or last node reaching during search
     */
     ...
     * @param p a Position of the tree serving as root of the subtree
     ...
     * @param key
     * @return entry with lease key greater than or equal to given (or null if no such entry)
     ...
     * (or null if no such key exists).
     * @param key
     * @return entry with greatest key less than or equal to given (or null if no such entry0
     * @throws IllegalArgumentException if the key is not compatible with the map
     */
    @Override
     ...
     * @throws IllegalArgumentException if fromKey or toKey is not compatible witht the map
     */
    @Override
     ...
     * with the new one an returns the old value. Otherwise, a new
    ...
    /**
     * Rebalances the tree after a child of a specified position has been
     * removed. This version of the method does not do anything, but it can be
     * overridden by subclasses.
